...
針對 `illumio-flow-ap-scp45-msig-mingtai-com-tw` bucket，2026-04-20 全量 list 結果：
...
pipelines:
  - name: "audit-to-fortisiem"
    ...
    filter:                        # 選配；省略代表全收
      expression: "ev.pce_fqdn == 'ap-scp45.illum.io'"
...
```
<134>1 2026-04-20T07:00:17.395Z ap-scp45.illum.io illumio-pce audit auditable - {"href":"/orgs/4456569/events/xxx","timestamp":"2026-04-20T07:00:17.395Z","created_by_agent_hostname":"coredapweb3",...}
```
...
```
<134>1 2026-04-20T07:00:17Z ap-scp45.illum.io illumio-pce summary pd1 - CEF:0|Illumio|PCE|1.0|1|Traffic pd=1 O|6|src=10.1.13.30 dst=10.1.13.34 dpt=17472 proto=6 cs1=1 cs1Label=PolicyDecision ...
```
...
```json
{
  ...
  "last_key": "ap-scp45.illum.io/org_id=4456569/auditable/20260420_a1ef5ccb-....jsonl.gz",
...
3. 真實環境對 `illumio-flow-ap-scp45-msig-mingtai-com-tw` 連線，`audit-to-fortisiem` pipeline 跑 5 分鐘，log 顯示 events sent > 0
